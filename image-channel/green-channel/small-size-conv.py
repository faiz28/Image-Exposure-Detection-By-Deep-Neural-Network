...
file = open(DIR+'small_size.txt',"w")
...
x = Conv2D(filters =3, kernel_size = (2,2),activation='relu', padding="same")(inputs)
...
def plot_loss_acc(history):
    ...
    plt.legend()
    plt.savefig(DIR + 'Small_CNN_training_validation_accuracy.png')
    plt.close()
    ...
    plt.savefig(DIR + 'Small_CNN_training_validation_loss.png')
    plt.close()
