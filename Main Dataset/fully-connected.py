...
def plot_loss_acc(history):
    ...
    plt.legend()
    plt.savefig(DIR + 'Fully_CNN_training_validation_accuracy.png')
    plt.close()
    ...
    plt.title('Fully_CNN-Training and validation loss')
    plt.legend()

    plt.savefig(DIR + 'Fully_CNN_training_validation_loss.png')
    plt.close()
